...
>(({ className, orientation = 'horizontal', ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="-mt-0.5 block h-4 w-4 rounded-full border border-primary/50 bg-background shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
  </SliderPrimitive.Root>
));
