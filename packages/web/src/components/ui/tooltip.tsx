...
>(({ className, sideOffset = 4, ...props }, ref) => (
  // Portal 把 tooltip 渲染到 body 末尾，避免被 fixed/absolute 容器（如 LyricViewer）的
  // stacking context 局限 — z-50 才能在全局生效，否则触发器位于 z-40 容器内时 tooltip 仅
  // 在该容器内层叠，结果会被同容器的兄弟元素（如歌词面板）遮挡。
